...
const NewPlace = () => {
    ...
    const addPlaceHandler = async event => {
        ...
        //Send formdata now instead of json
        ...
        try{
              //Once place is submitted, send request to backend with url specified
        await sendRequest(process.env.REACT_APP_URL + '/places/new', 
        'POST',
        formData, {
